...
rsync -au target/wasm32-unknown-unknown/release/meta_vote_contract.wasm res/

cargo build -p kv-store-contract --target wasm32-unknown-unknown --release
rsync -au target/wasm32-unknown-unknown/release/kv_store_contract.wasm res/

cargo build -p mpip-contract --target wasm32-unknown-unknown --release
rsync -au target/wasm32-unknown-unknown/release/mpip_contract.wasm res/

cargo build -p test-meta-token --target wasm32-unknown-unknown --release
rsync -au target/wasm32-unknown-unknown/release/test_meta_token.wasm res/
